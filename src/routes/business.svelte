...
<script>
  ...
  const advantages = [
    {
      tittle: "Оплата в 1 клик",
      text: "Заполните данные для выставления счёта один раз и используйте их для последующих заказов",
      icon:
  ...
  const solutions = [
    {
      tittle: "Новогодние букеты",
      photo: "solution1.jpg",
      breadcrumbs: ["Розы", "Шикарные"]
    },
    {
      tittle: "Новогодние композиции",
      photo: "solution2.jpg",
      breadcrumbs: ["Цветы", "Фрукты"]
    },
    {
      tittle: "Букеты на 23 февраля",
      photo: "solution3.jpg",
      breadcrumbs: ["Продукты", "Цветы", "Напитки"]
    },
    {
      tittle: "Букеты на 8 марта",
      photo: "solution4.jpg",
      breadcrumbs: ["Розы", "Хризантемы"]
    },
    {
      tittle: "Бизнес-поздравление",
      photo: "solution5.jpg",
      breadcrumbs: ["Розы", "Шикарные"]
    }
  ]
  ...
  let deliveryQA = [
    {
      question: "Как с вами подписать договор?",
      answer:
    ...
    {
      question: "Какие закрывающие документы вы предоставляете и как их получить?",
      answer:
        "Да, такая возможность предусмотрена, для этого при оформлении заказа нужно выбрать пункт «Доставка к точному времени» и указать желаемое время доставки. Стоимость доставки в таком случае увеличится на 250 руб."
    },
    {
    ...
    {
      question: "Можно ли оплатить заказ корпоративной банковской картой?",
      answer:
        "Да, такая возможность предусмотрена, для этого при оформлении заказа нужно выбрать пункт «Доставка к точному времени» и указать желаемое время доставки. Стоимость доставки в таком случае увеличится на 250 руб."
    },
    {
      question: "Можно ли создать один личный кабинет для нескольких сотрудников?",
      answer:
        "Да, такая возможность предусмотрена, для этого при оформлении заказа нужно выбрать пункт «Доставка к точному времени» и указать желаемое время доставки. Стоимость доставки в таком случае увеличится на 250 руб."
    }
  ]
...
<div class="page">
  <div class="header image-box relative">
    ...
    <p class="header__text">
      Поздравить коллег и партнёров, поблагодарить клиентов, оформить мероприятие теперь
      ещё проще с Розарио.Цветы
    </p>
  </div>
  <div class="h-full">
    <Tabbar
    ...
    <div class="business__body">
        ...
        <div class="flex">
          <div class="business__howitworkItem">
            <div class="flex">
              ...
              <div class="business__howitworkText">
                <span class="whitespace-nowrap">Создайте личный</span> кабинет
              </div>
            </div>
            <div>
              {#if width > 1200}
                ...
                >
                  <path
                    d="M80 10.7378L85 6.23378L80 1.73779"
                    stroke="#999999"
                    stroke-width="1.5"
              ...
              {:else}
                ...
                >
                  <path
                    d="M59.7656 10.7378L64.001 6.23378L59.7656 1.73779"
                    stroke="#999999"
                    stroke-width="1.5"
                    stroke-miterlimit="10"
                    stroke-linecap="round"
          ...
          <div class="business__howitworkItem">
            <div class="flex">
              ...
              <div class="business__howitworkText">
                Добавьте сотрудников, если необходимо
              </div>
            </div>
            <div>
              {#if width > 1200}
          ...
          <div class="business__howitworkItem">
            <div class="flex">
              ...
              <div class="business__howitworkText">
                Используйте все преимущества сервиса
              </div>
            </div>
          </div>
        </div>
      ...
      <section bind:this={ReadySolutions}>
        ...
        <p class="business__solutionsText">
          Мы подобрали букеты и композиции для разных случаев и на любой бюджет
        </p>
          ...
          {#each solutions as solution}
            <div class="business__solution">
              <ReadySolution
                ...
                breadcrumbs={solution.breadcrumbs}
              />
            </div>
          {/each}
        </div>
      ...
      <section bind:this={BuyersCard}>
        ...
        <p class="business__solutionsText">
          Более 1000 компаний в России отправляют цветы и подарки с помощью Розарио.Цветы
        </p>
      ...
      <section class="business__footer" bind:this={ContactUs}>
        ...
        <div class="flex">
          <div>
            <p class="business__footerText">
              Если у вас остались вопросы, позвоните нам:
            </p>
            <p class="mb-30 flex items-center">
              <a class="business__footerDescript" href="tel:88002506470"
                >8 (800) 250-64-70</a
              >
              <span class="business__footerTextMini ml-6">(бесплатно по России)</span>
            </p>
            ...
            <div class="flex items-center">
              <span>
                ...
                >
                  <path
                    d="M21.0063 0.5H2.99375C1.89375 0.5 1 1.3927 1 2.49142V14.5086C1 15.6073 1.89375 16.5 2.99375 16.5H21.0063C22.1063 16.5 23 15.6073 23 14.5086V2.49142C23 1.3927 22.1063 0.5 21.0063 0.5ZM20.7313 1.73605L12 8.397L3.26875 1.73605H20.7313ZM21.0063 15.1953H2.99375C2.58125 15.1953 2.2375 14.8519 2.2375 14.4399V2.49142L11.6562 9.63305C11.7937 9.70172 11.9312 9.77039 12 9.77039C12.0688 9.77039 12.275 9.70172 12.3438 9.63305L21.7625 2.49142V14.4399C21.7625 14.8519 21.4188 15.1953 21.0063 15.1953Z"
                    fill="#CC6699"
                    stroke="#CC6699"
                    stroke-width="0.2"
                  />
              ...
              <a class="business__footerDescript ml-12" href="mailto:info@rozariofl.ru"
                >info@rozariofl.ru</a
              >
            </div>
          </div>
          <div class="business__footerAirplane">
            ...
            >
              <path
                d="M73.9107 34.0583L168.553 13.3328L125.414 67.0111L114.236 61.8838L109.778 55.9637L97.8378 64.5921L92.7739 41.4394L79.9929 41.1082L73.9107 34.0583Z"
                fill="white"
              />
              <path
                d="M97.6222 64.5448L92.5898 41.5848L168.389 13.5925L106.114 51.3349L97.6222 64.5448Z"
                fill="#E9E9E9"
              />
              <path
                d="M109.573 56.0529L106.428 51.6497C103.702 55.7384 98.25 63.9788 98.25 64.2305C98.25 64.4821 105.798 58.8836 109.573 56.0529Z"
                fill="#C4C4C4"
              />
              <path
                d="M168.553 13.3328L73.9107 34.0583L79.9929 41.1082L92.7739 41.4394M168.553 13.3328L125.414 67.0111L114.236 61.8838L109.778 55.9637M168.553 13.3328L92.7739 41.4394M168.553 13.3328L106.116 51.1008M106.116 51.1008L97.8378 64.5921M106.116 51.1008L109.778 55.9637M97.8378 64.5921L92.7739 41.4394M97.8378 64.5921L109.778 55.9637"
                stroke="#330033"
                stroke-width="3"
                stroke-linejoin="round"
              />
              <path
                d="M90.0134 66.4317C90.0134 66.4317 68.0302 64.8481 52.8852 81.3191C47.4605 87.2188 27.5739 123.724 52.8632 143.106C57.3871 146.573 69.8818 150.483 74.9902 142.595C78.2957 137.491 74.1949 129.285 67.7616 124.307C65.6197 122.65 29.0933 100.809 8.69442 143.154C-7.39804 176.56 23.9218 198.923 23.9218 198.923"
                stroke="#330033"
                stroke-width="3"
                stroke-linecap="round"
                stroke-dasharray="4 8"
    ...
    <a href="profile/business#RequisitesBlock">
      ...
      {:else}
        <Button size="full" className="mt-6 mb-10" on:click={closeSignInModal}
          >Стать корпоративным клиентом</Button
        >
      {/if}
    </a>
  </div>
