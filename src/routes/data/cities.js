const cities = [
  {
    ...
    reviews: [
      ...
      },
      {
        ...
        message:
          "Спасибо большое, за доставленный маме букет! Букет яркий, сочный! Очень понравился! Переживала сначала,что заменили цветы( предварительно согласовали), но оказалось всё очень здорово!!! ( фото букета скинули, за что большое спасибо!) ",
        ratings: []
      },
      {
        orderId: "12345678",
      ...
      },
      {
        ...
        message:
          "Спасибо за оперативную доставку цветов, в течение трех часов. Заказ оформила удаленно с Ханты-Мансийского округа. Бесконечно благодарны за слаженную работу. Процветания и финансовой стабильности!!",
        ratings: [
          {
            title: "Свежесть цветов",
            rate: 5
      ...
      },
      {
        ...
        message:
          "Огромное спасибо за оперативность и внимание к клиентам! Позвонили для уточнения заказа, доставили в указанное время и связались с получателем (супруга уже вышла с работы) и вручили букет! оценка 10 из 10!",
        ratings: [
          {
            title: "Свежесть цветов",
            rate: 5
      ...
      },
      {
        ...
        message:
          "Спасибо вам большое за вашу работу! Операторы вежливые, пунктуальные, почти каждое движение букета отслеживали! Свекровь в полном воссторге! Еще раз спасибо",
        ratings: [
          {
            title: "Свежесть цветов",
            rate: 5
      ...
      },
      {
        ...
        message:
          "Быстрая доставка. Цветы свежие, великолепные. Благодарю! Сервис на уровне! Очень здорово, что вот так помогаете на расстоянии 1000 км порадовать близких!",
        ratings: [
          {
            title: "Свежесть цветов",
            rate: 5
