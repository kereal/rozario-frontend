...
<script>
  ...
  export let dataShop = {
    ...
    contacts: [
      ...
      {
        name: "E-mail (для информирования)",
        placeholder: "E-mail (для информирования)",
        type: "text",
        value: "www.rozario@info.ru",
        id: "email"
      },
      {
        name: "Вконтакте",
  ...
  export let listEmployees = [
    ...
    },
    {
      group: "Менеджеры",
      groupDiscription:
        "Доступны все разделы, кроме финансов. Управляют флористами и курьерами",
      listWorkers: [
        {
    ...
    },
    {
      group: "Курьеры",
      groupDiscription:
        "Получают назначенные на них заказы только через приложение Розарио.Курьер",
      listWorkers: [
        {
          name: "Ехидна Наклз",
          phone: "+7 921 225-53-71",
...
<div class="data">
  <div class="flex w-full justify-between">
    <div class="w-full mr-10 mb-10">
      ...
      />
      <div class="content">
        <section class="date__Name" data-scrollspy bind:this={Name}>
          <h2 class="sectionName">Название</h2>
          <div class="sectionBody">
            <label for="dataShop_name" class="label-text"> Название магазина </label>
            <div class="inputs">
              <TextInput
                required={true}
                name="dataShop_name"
        ...
        <section class="date__Address" data-scrollspy bind:this={Address}>
          <h2 class="sectionName">Адрес</h2>
          <div class="sectionBody">
            <label for="dataShop_name" class="label-text"> Населённый пункт </label>
            <div class="inputs">
              <TextInput
                required={true}
                name="dataShop_sity"
            ...
            <label for="dataShop_name" class="label-text mt-24"> Адрес магазина </label>
            <div class="inputs">
              <TextInput
                required={true}
        ...
        <section class="date__workingHours" data-scrollspy bind:this={WorkingHours}>
          <h2 class="sectionName">Режим работы</h2>
          <div class="sectionBody inputs">
            <WorkingHoursComp bind:time={dataShop.time} extended={true} />
          </div>
        </section>
        <section class="date__Contacts" data-scrollspy bind:this={Contacts}>
          ...
          <div class="sectionBody" id="formdata">
            ...
            <Button
              ...
              size="lg"
              className="mt-34"
              on:click={toggleaddContact}
            >
              Добавить способ связи
            </Button>
          </div>
        </section>
        <section class="date__Delivery" data-scrollspy bind:this={Delivery}>
          <h2 class="sectionName">Доставка</h2>
          <div class="sectionBody">
            <h3 class="subSectionName">Время доставки по городу</h3>
            <p class="date__subscribeText">
              Укажите минимальное количество времени в минутах, необходимое для того,
              чтобы собрать заказ и доставить его получателю (не в период праздников)
            </p>
            <div class="inputs mt-24 mb-34">
              <SelectLabel
                list={minTimeList}
                bind:select={dataShop.deliveryTime.min}
                size="full"
              />
            </div>
            <h3 class="subSectionName">Стоимость доставки по городу</h3>
            <p class="date__subscribeText mb-30">Укажите стоимость доставки по городу</p>
            ...
            <p class="date__subscribeText mb-18">
              Стоимость удалённой доставки считается по формуле: <span
                class="text-main font-semibold whitespace-nowrap"
                >стоимость забора заказа + стоимость 1 км × кол-во км</span
              >
            </p>
            <p class="label-text">Стоимость забора заказа</p>
            <div class="inputs mb-20">
              <SelectLabel
                list={pricePicking}
                bind:select={dataShop.deliveryTime.pricePicking}
                size="full"
              />
            </div>
            ...
            <div class="inputs mb-20">
              <SelectLabel
                list={priceOneKm}
                bind:select={dataShop.deliveryTime.priceOneKm}
                size="full"
              />
            </div>
            ...
            <div class="inputs mb-20">
              <SelectLabel
                list={deliveryRadius}
                bind:select={dataShop.deliveryTime.deliveryRadius}
                size="full"
              />
            </div>
            ...
            <div class="inputs mb-12">
              <SelectLabel
                list={exactTime}
                bind:select={dataShop.deliveryTime.exactTime}
                size="full"
              />
            </div>
        ...
        <section class="date__Staff" data-scrollspy bind:this={Staff}>
          <h2 class="sectionName">Сотрудники</h2>
          <div class="sectionBody">
            <p class="date__subscribeText mb-34">
              Добавляйте сотрудников, чтобы они могли принимать и обрабатывать заказы,
              управлять аккаунтом.
            </p>
            <BusinessListWorkersData bind:listEmployees />
          </div>
        </section>
        <section class="date__Staff" data-scrollspy bind:this={Requisites}>
          <h2 class="sectionName">Реквизиты</h2>
          <div class="sectionBody">
            <p class="date__subscribeText">Для заключения договора и получения выплат.</p>
            <p class="date__subscribeText">
