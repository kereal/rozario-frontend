      ...
      colors: [
        {
          ...
          style: "#E81717",
          prices: [
            { count: "1–15 шт.", price: 150 },
            { count: "16–25 шт.", price: 150 },
            { count: "26–51 шт.", price: 150 },
            { count: "52–101 шт.", price: 150 }
          ],
          checked: true
        },
        {
  ...
  let greens = [
    {
      ...
      selected: true,
      colors: [
        { color: "красный", style: "#E81717", price: 120, checked: true },
        { color: "розовый", style: "#FF84A9", price: 120, checked: true },
        { color: "жёлтый", style: "#FFF969", price: 120, checked: true }
      ]
    },
    {
      name: "Рускус израиль",
  ...
  export let decors = [
    {
      ...
      selected: true,
      colors: [
        { color: "красный", style: "#E81717", price: 122, checked: true },
        { color: "розовый", style: "#FF84A9", price: 322, checked: true },
        { color: "жёлтый", style: "#FFF969", price: 15, checked: true },
        { color: "зелёный", style: " #12C97D", price: 44, checked: true }
      ]
    },
    {
      name: "Топпер",
      selected: true,
      colors: [
        { color: "красный", style: "#E81717", price: 12, checked: true },
        { color: "розовый", style: "#FF84A9", price: 31, checked: true },
        { color: "жёлтый", style: "#FFF969", price: 21, checked: true }
      ]
    }
  ]
  export let packages = [
    {
      ...
      selected: true,
      colors: [
        { color: "маленькая", price: 122, checked: true },
        { color: "средняя", price: 322, checked: true },
        { color: "большая", price: 15, checked: true }
      ]
    },
    {
      name: "Бумага",
...
<div class="data">
  <div class="flex w-full justify-between">
    <div class="w-full mr-10 mb-10">
      ...
      />
      <div class="content">
        <section class="section__flower" data-scrollspy bind:this={Flowers}>
          <h2 class="sectionName">Цветы</h2>
          <p class="date__subscribeText">
            Выберите позиции, которые всегда есть в наличии, и укажите цены в зависимости
            от количества цветов в букете.
          </p>
          <div class="sectionBody">
            <ShowcaseTable products={flowers} />
          </div>
        </section>
        <section data-scrollspy bind:this={Greens}>
          <h2 class="sectionName">Зелень</h2>
          <p class="date__subscribeText">
            Выберите составляющие, которые всегда есть в наличии, и укажите цены
          </p>
          <div class="sectionBody">
            <ShowcaseTable products={greens} onePrice={true} />
          </div>
        </section>
        <section data-scrollspy bind:this={Packaging}>
        ...
        <section data-scrollspy bind:this={Decor}>
        ...
        <section data-scrollspy bind:this={Gifts}>
