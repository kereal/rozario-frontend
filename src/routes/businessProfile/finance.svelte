...
<div class="data">
  <div class="flex w-full justify-between">
    <div class="w-full mr-10 mb-10">
      ...
      />
      <div class="content">
        <section class="section__flower" data-scrollspy bind:this={Personalaccount}>
          <h2 class="sectionName">Личный счёт</h2>
          <p class="date__subscribeText">
            Оплата по заказу поступает только после его выполнения. В течение 72 часов
            деньги находятся на заблокированном счёте, затем попадают на ваш основной
            счёт, и становятся доступны для вывода.
          </p>
          <p class="date__subscribeText mt-12">
            Срок поступления денежных средств на ваш расчётный счёт может составлять до 7
            рабочих дней.
          </p>
        ...
        <section data-scrollspy bind:this={History}>
        ...
        <section data-scrollspy bind:this={Agentreport}>
...
{#if removeMoney}
  <RemoveMoneyWindow {listOrder} bind:visible={removeMoney} />
{/if}
