...
<div class="wrapper">
  <div class="content">
    <div class="content__header" id="businessHeader">
      <HeaderBusinessRegistration bind:status />
    </div>
    <div class="content__body">
      {#if status == "name"}
        <h2>Название</h2>
        <p class="descriptText">Укажите название магазина.</p>
        <div class="input mt-30">
          <label for="Shop_name" class="label-text"> Название магазина </label>
          <div class="inputs">
            <TextInput
              required={true}
              name="Shop_name"
      ...
      {#if status == "address"}
        <div class="flex justify-between">
          <div>
            <h2>Адрес</h2>
            <p class="descriptText">Укажите адрес и тип магазина.</p>
            <div class="input mt-30">
              <label for="Shop_sity" class="label-text"> Населённый пункт </label>
              <div class="inputs">
                <TextInput
                  required={true}
                  name="Shop_sity"
              ...
              <label for="Shop_adress" class="label-text mt-24"> Адрес магазина </label>
              <div class="inputs">
                <TextInput
                  required={true}
                  name="Shop_adress"
      ...
      {#if status == "time"}
        <h2>Режим работы</h2>
        <p class="descriptText">Укажите режим работы магазина.</p>
        <div class="input mt-30">
      ...
      {#if status == "contacts"}
        <h2>Контакты</h2>
        <p class="descriptText">Укажите способы связи с магазином.</p>
        <div class="input mt-30">
          <div class="validation inputs">
            <label for="dataShop_phone" class="label-text"> Телефон </label>
            <TelInput
              name="phone"
              id="shop_phone"
              className="w-full"
          ...
          <TextInput
            ...
            className="w-full"
          />
          <label for="dataShop_Incontact" class="label-text mt-24"> Вконтакте </label>
          <TextInput
          ...
          />
          <label for="dataShop_Facebook" class="label-text mt-24"> Facebook </label>
          <TextInput
            required={true}
            ...
            placeholder="Логин или ссылка на страницу"
          />
          <label for="dataShop_Instagram" class="label-text mt-24"> Instagram </label>
          <TextInput
            required={true}
          ...
          <TextInput
            ...
            placeholder="Логин или ссылка на страницу"
          />
          <label for="dataShop_Twitter" class="label-text mt-24"> Твиттер </label>
          <TextInput
            required={true}
          ...
          />
          <div class="validation inputs">
            <label for="dataShop_Whatsapp" class="label-text  mt-24"> Whatsapp </label>
            <TelInput
              name="Whatsapp"
              id="shop_Whatsapp"
              className="w-full"
          ...
          <div class="validation inputs">
            <label for="dataShop_Viber" class="label-text  mt-24"> Viber </label>
            <TelInput
              name="Viber"
              id="shop_Viber"
              className="w-full"
          ...
          <label for="dataShop_Telegram" class="label-text mt-24"> Telegram </label>
          <TextInput
          ...
          />
          <label for="dataShop_Youtube" class="label-text mt-24"> Youtube </label>
          <TextInput
          ...
          />
          <label for="dataShop_WebSite" class="label-text mt-24"> Веб-сайт </label>
          <TextInput
      ...
      {#if status == "delivery"}
        ...
        <p class="descriptText">
          Укажите минимальное количество времени в минутах, необходимое для того, чтобы
          собрать заказ и доставить его получателю (не в период праздников)
        </p>
        <div class="input mt-24 mb-34">
          <SelectLabel
            list={minTimeList}
            bind:select={shop.deliveryTime.min}
            size="full"
          />
        </div>

        <h3>Стоимость доставки по городу</h3>
        <p class="descriptText">Укажите стоимость доставки по городу</p>
        <div class="input">
        ...
        <p class="descriptText">
          Стоимость удалённой доставки считается по формуле: <span
            class="font-semibold text-main mt-24 whitespace-nowrap"
            >стоимость забора заказа + стоимость 1 км × кол-во км</span
          >
        </p>
        <p class="label-text mt-24">Стоимость забора заказа</p>
        <div class="input mb-24">
          <SelectLabel
            list={pricePicking}
            bind:select={shop.deliveryTime.pricePicking}
            size="full"
          />
        </div>
        <p class="label-text">Стоимость 1 км</p>
        <div class="input mb-24">
          <SelectLabel
            list={priceOneKm}
            bind:select={shop.deliveryTime.priceOneKm}
            size="full"
          />
        </div>
        <p class="label-text">Радиус доставки</p>
        <div class="input mb-24">
          <SelectLabel
            list={deliveryRadius}
            bind:select={shop.deliveryTime.deliveryRadius}
            size="full"
          />
        </div>
        <p class="label-text">Стоимость доставки к точному времени</p>
        <div class="input mb-12">
          <SelectLabel
            list={exactTime}
            bind:select={shop.deliveryTime.exactTime}
            size="full"
          />
        </div>
      ...
      {#if status == "finish"}
        <div class="flex">
          <div>
            <div class="mb-40">
              <h2>
                Спасибо за регистрацию в Розарио.<span class="font-light">Цветы</span>
              </h2>
              <div class="descriptText">
                Данные отправлены на модерацию, наш сотрудник свяжется с вами в течение
                двух рабочих дней.
              </div>
              <div class="descriptText">
                Аккаунт станет активен после успешного прохождения модерации.
              </div>
              <div class="descriptText">
                Пока вы можете установить приложение для работы и указать цены на цветы и
                другие составляющие.
              </div>
            </div>
            <div class="flex justify-between items-end">
              <div class="mr-24">
                ...
                <p class="mini-text">
                  Вам пришло смс с ссылкой на приложение. Авторизуйтесь, чтобы оперативно
