...
<form class="cart-grid">
  {#if tab === "me"}
    <div class="cart-grid-main h-full rounded">
      <div class="wrapper">
        ...
        <AddressCard bind:address tab="me" />
        <span class="block w-full h-68" />
        <DateCard bind:date tab="me" bind:address />
        <span class="block w-full h-68" />
        <MiscellaneousCard />
        <span class="block w-full h-68" />
  ...
  {:else if tab === "other"}
    <div class="cart-grid-main h-full">
      <div class="wrapper">
        ...
        <RecieverCard />
        <span class="block w-full h-68" />
        <AddressCard bind:address tab="other" />
        <span class="block w-full h-68" />
        <DateCard bind:date tab="other" bind:address />
        <span class="block w-full h-68" />
  ...
  <button
    ...
    cart-grid-pay text-main bg-accent w-full text-center rounded hover:bg-info hover:text-white"
    on:click={scrollToError}
  >
    <div class="flex justify-center items-center">
      ...
      {#if $currPaymentStore === "GooglePay"}
        ...
        >
          <path
            d="M18.3451 9.74422C18.3459 9.09498 18.292 8.44686 18.1839 7.80701H9.3584V11.4763H14.4133C14.3098 12.0624 14.0909 12.621 13.7697 13.1186C13.4484 13.6162 13.0316 14.0424 12.5442 14.3716V16.7534H15.561C17.3274 15.0954 18.3451 12.6434 18.3451 9.74422Z"
            fill="#4285F4"
          />
          <path
            d="M9.35857 19.0546C11.8841 19.0546 14.0105 18.2103 15.5611 16.7548L12.5443 14.373C11.7047 14.9525 10.6233 15.2833 9.35857 15.2833C6.91758 15.2833 4.84573 13.6081 4.10485 11.3507H0.99707V13.8053C1.77599 15.3832 2.97037 16.7097 4.44688 17.6366C5.92338 18.5636 7.6239 19.0545 9.35857 19.0546Z"
            fill="#34A853"
          />
          <path
            d="M4.10429 11.3507C3.71262 10.1678 3.71262 8.88677 4.10429 7.70386V5.24927H0.996508C0.341255 6.57667 0 8.04168 0 9.52727C0 11.0129 0.341255 12.4779 0.996508 13.8053L4.10429 11.3507Z"
            fill="#FBBC04"
          />
          <path
            d="M9.35858 3.77122C10.6932 3.74903 11.9828 4.26238 12.9486 5.20031L15.6196 2.48107C13.9259 0.861539 11.6821 -0.0276131 9.35858 1.47261e-05C7.6239 9.52118e-05 5.92338 0.491006 4.44688 1.41794C2.97037 2.34487 1.77599 3.67135 0.99707 5.24927L4.10485 7.70387C4.84573 5.44643 6.91758 3.77122 9.35858 3.77122Z"
            fill="#EA4335"
          />
        </svg> <span>Pay</span>
      {/if}
