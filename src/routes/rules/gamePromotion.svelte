<script>
    ...
    export let texts = [
        {
            ...
            text: [{text:'Настоящие Правила содержат сведения о стимулирующем мероприятии «Розарио.Игра» (далее — Акция).'},
                    ...
                    {text:'Организатор: Общество с ограниченной ответственностью ООО «Розарио»,' +
                    ...
                    {text:'Полные условия Акции размещены на сайте www.rozarioflowers.ru (далее — сайт).' +
        ...
        },
        {
            ...
            text: [
               {
                   text:'Участником Акции (далее в тексте — «Участник») может стать дееспособный гражданин в возрасте от 18 лет.' +
                    ...
                    {text:'Акция «Закрути и выиграй» проводится на сайте https://rozarioflowers.ru,' +
                        ...
                        'а также не компенсирует Участникам стоимость использования сети Интернет.'},
                {
                    ...
                    subtext: [{text:'в период с 00 часов 00 минут московского времени 21 февраля 2019 года до 23 часов 59 минут московского времени 24 апреля 2019 года участник должен, посетить  «Закрути и выиграй» на сайте https://rozarioflowers.ru (далее в тексте — сайт);'},
   ...
   const navlist = [
       ...
       {name: "Правила акции «Розарио.Игра»", link: "rules/gamePromotion", active: true},
    ];
