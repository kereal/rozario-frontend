<script>
  ...
  let recommendation = {
    ...
    size: {},
    description:
      "Роза малиновая — 3 шт., Роза кустовая розовая — 3 шт., Листья эвкалипта, Хризантема кустовая белая — 3 шт., Лимониум синий — 2 шт.",
  ...
  export let newBouquet = {
    ...
    colors: [
      ...
      {
        color:
          "conic-gradient(from 180deg at 50% 50%, #FF0000 0deg, #FAFF00 50.63deg, #00FF0A 101.25deg, #00F0FF 172.5deg, #0029FF 230.62deg, #BD00FF 286.87deg, #FF0000 350.63deg, #FF0000 360deg);",
        name: "разноцветный",
        id: "multicolored"
      }
    ]
  ...
  onMount(async () => {
    ...
    if (
      ...
      navigator.indexOf("webOS") == -1 &&
      navigator.indexOf("iPhone") == -1 &&
      navigator.indexOf("iPad") == -1 &&
      navigator.indexOf("iPod") == -1 &&
      navigator.indexOf("BlackBerry") == -1 &&
      navigator.indexOf("IEMobile") == -1 &&
      navigator.indexOf("Opera Mini") == -1
    ) {
      console.log("done")
    } else {
  ...
  $: if (selectedCongratulation && !once) {
    if (selectedCongratulation != "Без открытки") togglepostCardModalVisible()
  }
  let packagePrice
  $: if (numberPackage) {
...
{#if postCardModalVisible}
  <PostCardModal
    bind:value={congratulations[selectedCongratulation].intermediate}
    bind:texts={congratulations[selectedCongratulation]}
    bind:selectedCongratulation
    on:close={togglepostCardModalVisible}
    focused
  />
{/if}
        ...
        <div class="product__fixedButton_left">
          ...
          >
            <section class="leading-tight rounded bg-white px-32 py-24">
              <h2 class="text-main text-lg font-bold mb-8">Доставка Розарио.Цветы</h2>
          ...
          <p class="whitespace-nowrap">
            Стоимость доставки: <span class="highlighting ">0–549 ₽</span>
          </p>
          <p>
            Ближайшая дата доставки: <span class="highlighting"
              >22.02.2020, <span class="whitespace-nowrap">в течение 120 мин</span></span
            >
          </p>
        </div>
        <div class="product__fixedButton_right flex items-center">
          {#if product.composite}
            <div class="flex items-center product__price">
              <span class="product__price_main flex"
                ><AnimateNumber
                  number={Math.round(
                    ((packagePrice + numberSize.price - couponDeal - couponNew) / 100) *
                      (100 - product.chip)
                  )}
                /> &nbsp;₽</span
              >
              <span class="product__price_withDiscount whitespace-nowrap"
                >{String(
                  numberSize.price + packagePrice - couponDeal - couponNew
          ...
          {:else}
            <div class=" flex items-center product__price">
              <span class="product__price_main flex"
                ><AnimateNumber
                  number={Math.round(
                    packagePrice +
                      ((amountFlowers *
                        newBouquet[selectedFlower].sizes[sizeFlower].price -
                        couponDeal -
                        couponNew) /
                        100) *
                        (100 - product.chip)
              ...
              <span class="product__price_withDiscount whitespace-nowrap"
                >{String(
                  amountFlowers * newBouquet[selectedFlower].sizes[sizeFlower].price +
                    packagePrice -
                    couponDeal -
                    couponNew
                ).replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g, "$1 ")} ₽</span
          ...
          <div class="flex items-center">
            <div class="mr-18">
              <Button
                size="lg"
                status={productAdded ? "active-secondary" : "active-main"}
                on:click={() => {
      ...
      <div class="product__configurations">
                ...
                <div class="OutLineRadio product__size-button">
                  {#if size.available == true}
                    <div>
                      ...
                      />
                      <label
                        class=" cursor-pointer rounded leading-snug border border-gray-500 hover:text-main hover:border-gray-700 flex  whitespace-nowrap mb-12"
                        for={size.id}
                        ...
                        <div class="flex items-center">
                          ...
                          {#if numberSize == size}
                            <span class="mini-size items-center">
                              ...
                              >
                                <path
                                  d="M4.28537 7.99995L1 4.50046L4.28537 1.00098"
                                  stroke="#330033"
                                ...
                                />
                                <path
                                  d="M10.7158 1L14.0002 4.49949L10.7158 7.99897"
                                  stroke="#330033"
                                  stroke-miterlimit="10"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                              ...
                              >
                                <path
                                  d="M7.99995 10.7146L4.50046 14L1.00098 10.7146"
                                  stroke="#330033"
                                  stroke-miterlimit="10"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                                />
                                <path
                                  d="M1 4.28418L4.49949 0.999802L7.99897 4.28418"
                                  stroke="#330033"
                                  stroke-miterlimit="10"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                                />
                                <path
                                  d="M4.50098 13.6597L4.50098 1.38579"
                                  stroke="#330033"
                                  stroke-miterlimit="10"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                ...
                {#if width > 1150}
                  {#each amount as item, i}
                    <div class="OutLineRadio">
                      ...
                      />
                      <label
                        class="cursor-pointer rounded leading-snug border border-gray-500 hover:text-main hover:border-gray-700 amountFlowerText"
                        for={i}
                      >
                        {item.count}
                      </label>
                  ...
                  {#each newBouquet.colors as color}
                    <div class="colorBouquet items-center">
                      ...
                      <label class="flex" for={color.id}>
                        <div class="flex items-center">
                          <div
                            class="colorBouquet__square "
                            style="background:{color.color} {color.name == 'белый'
                              ? 'border: 1px solid var(--gray-1100); border-radius: 4px;'
                              : ''}"
                          />
        ...
        <div class="product__conditions">
          <div class="param__container">
            ...
            {#if holidays}
              <AutoWidthButtons
                bind:group={selectedCongratulation}
                selectedText="Еще"
                list={holidays}
                buttonElement=""
              />
            ...
            {#if selectedCongratulation != "Без открытки" && congratulations[selectedCongratulation].UserText != ""}
              {congratulations[selectedCongratulation].UserText == ""
                ? (selectedCongratulation = "Без открытки")
                : ""}
              <div
                class="product__postCartBlock relative"
                on:click={togglepostCardModalVisible}
              >
                <p class="break-words">
                  {congratulations[selectedCongratulation].UserText}
                </p>
          ...
          <div class="product__buyersGuarantees">
            <div class="flex">
              ...
              >
                <section class="leading-tight rounded bg-white guarantee__container">
                  <h3 class="text-main text-lg font-bold">Гарантии качества</h3>
                    ...
                    <div class="guarantee__left">
                      <div class="guarantee__item flex">
                        ...
                        <div class="guarantee__text">
                          ...
                          <p class="">
                            Мы собираем букеты только из свежих цветов высшего качества
                          </p>
                        </div>
                      </div>
                      <div class="guarantee__item flex">
                        ...
                        <div class="guarantee__text">
                          ...
                          <p class="">
                            Не понравился букет? Сообщите нам об этом в течение 24 часов,
                            и мы заменим его на новый.
                          </p>
                        </div>
                      </div>
                      <div class="guarantee__item flex">
                        ...
                        <div class="guarantee__text">
                          ...
                          <p class="">
                            Мы всегда согласуем с вами любые изменения в заказе, а также
                            сообщим, если не удалось связаться с получателем букета.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div class="guarantee__right">
                      <div class="guarantee__item flex">
                        ...
                        <div class="guarantee__text">
                          ...
                          <p class="">
                            Все букеты с любовью собирают опытные флористы, настоящие
                            мастера своего дела.
                          </p>
                        </div>
                      </div>
                      <div class="guarantee__item flex">
                        ...
                        <div class="guarantee__text">
                          ...
                          <p class="">
                            В последний момент передумали или решили отказаться от
                            покупки? Ничего страшного! Свяжитесь с нами до момента сборки
                            букета, и мы учтём ваши пожелания.
                          </p>
                        </div>
                      </div>
                      <div class="guarantee__item flex">
                        ...
                        <div class="guarantee__text">
                          ...
                          <p class="">
                            Наши курьеры безупречно вежливы, и всегда доставляют заказы
                            точно в срок.
                          </p>
                        </div>
                      </div>
            ...
            <p>
              100% гарантия свежести. Счастливый получатель. Замена букета. Пунктуальная
              доставка.
            </p>
          </div>
          <div>
            <h3 class="flex items-center mt-34 text-main font-semibold text-sm">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="mr-8"
                width="18"
            ...
            <p>
              Вы можете бесплатно отменить заказ до получения фото букета, деньги
              полностью вам вернутся. При отмене заказа после получения фото букета деньги
              не возвращаются
            </p>
          </div>
        </div>
    ...
    <section class="feedback">
      <div class="feedback__clients-photos">
        ...
        <p class="feedback__text">
          Очаровательные улыбки, запечатлённые нашей службой доставки
        </p>
        <Slider
          sliderName="smile"
          forDesktop="4"
        ...
        <div class="feedback__product-photos">
          <div class="feedback__product-photo">
            <picture>
              ...
              />
              <img
                data-srcset="https://i.ibb.co/tpLGpJf/image-1.jpg.img-2x.png 2x"
            ...
            <noscript>
              <img
                srcset="https://i.ibb.co/KK5WzzS/image-2.jpg-2x.png 2x"
                src="./11.png"
                alt="photo"
              />
            </noscript>
          ...
          <div class="feedback__product-photo">
            <picture>
              ...
              />
              <img
                data-srcset="https://i.ibb.co/KK5WzzS/image-2.jpg.img-2x.png 2x"
          ...
          <div class="feedback__product-photo">
            <picture>
              ...
              />
              <img
                data-srcset="https://i.ibb.co/Nmg89bk/image-3.jpg.img-2x.png 2x"
            ...
            <noscript>
              <img
                srcset="https://i.ibb.co/Nmg89bk/image-3.jpg-2x.png 2x"
                src="./11.png"
                alt="photo"
              />
            </noscript>
