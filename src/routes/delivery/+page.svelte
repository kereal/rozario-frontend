    ...
    <div class="delivery__body">
      <div bind:this={methods} class="delivery__methods">
        ...
        <div class="delivery__Methods_Time flex">
          {#if cityMeta.delivery_methods.free}
            <div
              class="flex delivery__Method delivery__Method_free {countMethods == 2
                ? 'w-full'
                : 'w-auto'}"
            >
              <div class="delivery__Method_icon flex ">
                ...
                >
                  <path
                    d="M35.3532 23.0004C35.3532 29.9062 29.8409 35.4308 22.9506 35.4308C16.0602 35.4308 10.5479 29.9062 10.5479 23.0004C10.5479 16.0945 16.0602 10.5698 22.9506 10.5698C29.8409 10.5698 35.3532 16.0945 35.3532 23.0004Z"
                    stroke="#330033"
                    stroke-width="2"
                    stroke-miterlimit="10"
                  />
                  <path
                    d="M7.49658 7.4126L10.4496 10.3722"
                    stroke="#330033"
                    stroke-width="2"
                    stroke-miterlimit="10"
                  ...
                  />
                  <path
                    d="M35.5503 35.6279L38.5033 38.5876"
                    stroke="#330033"
                    stroke-width="2"
                    stroke-miterlimit="10"
                    stroke-linecap="round"
                  ...
                  />
                  <path
                    d="M10.6001 36.1001L7.6001 39.1001"
                    stroke="#330033"
                    stroke-width="2"
                    stroke-miterlimit="10"
                    stroke-linecap="round"
              ...
              <div class="delivery__Method_text">
                <h4>
                  <span class="whitespace-nowrap">с 08:00 до 21:00</span>,
                  <span class="whitespace-nowrap"> интервал 2 часа</span>
                </h4>
          ...
          {#if cityMeta.delivery_methods.interval}
            <div
              class="flex delivery__Method delivery__Method_interval {countMethods == 2
                ? 'w-full'
                : 'w-auto'}"
            >
              <div class="delivery__Method_icon flex ">
                ...
                >
                  <path
                    d="M26.2118 1C23.2915 1 20.5659 1.66749 18.1323 2.81182C24.4596 5.76801 28.8401 12.1572 28.8401 19.5C28.8401 26.8428 24.4596 33.2319 18.1323 36.1881C20.5659 37.3325 23.2915 38 26.2118 38C36.6275 38 44.999 29.7036 44.999 19.5954C45.0963 9.20103 36.6275 1 26.2118 1Z"
                    stroke="#330033"
                    stroke-width="2"
                    stroke-miterlimit="10"
                    stroke-linecap="round"
                  ...
                  />
                  <path
                    d="M8.30074 11.8711L10.5396 16.3531L15.6015 17.1159L11.9024 20.549L12.7786 25.5077L8.30074 23.1237L3.82297 25.5077L4.69903 20.549L1 17.1159L6.06185 16.3531L8.30074 11.8711Z"
                    stroke="#330033"
                    stroke-width="2"
                    stroke-miterlimit="10"
                    stroke-linecap="round"
              ...
              <div class="delivery__Method_text">
                <h4>
                  <span class="whitespace-nowrap">с 21:00 до 08:00</span>,
                  <span class="whitespace-nowrap"> интервал 2 часа</span>
                </h4>
          ...
          {#if cityMeta.delivery_methods.exact}
            <div
              class="flex delivery__Method delivery__Method_exact {countMethods == 2
                ? 'w-full'
                : 'w-auto'}"
            >
              <div class="delivery__Method_icon flex ">
                ...
                >
                  <path
                    d="M45 22.9997C45 35.1404 35.1408 45 23 45C10.8592 45 1 35.1404 1 22.9997C1 10.8589 10.8592 1 23 1C35.1408 1 45 10.8589 45 22.9997Z"
                    stroke="#330033"
                    stroke-width="2"
                    stroke-miterlimit="10"
                    stroke-linecap="round"
                  ...
                  />
                  <path
                    d="M22.9994 8.98535V25.5536L15.8018 20.6373"
                    stroke="#330033"
                    stroke-width="2"
                    stroke-miterlimit="10"
                    stroke-linecap="round"
              ...
              <div class="delivery__Method_text">
                ...
                <p>
                  <span class="delivery__Method_time whitespace-nowrap"
                    >с 08:00 до 21:00</span
                  ><span class="delivery__Method_price whitespace-nowrap">— 250 ₽</span>,
                  <span class="delivery__Method_time whitespace-nowrap"
                    >с 21:00 до 08:00
                  </span><span class="delivery__Method_price whitespace-nowrap"
                    >— 549 ₽</span
                  >
                </p>
              </div>
        ...
        {#if route}
          <p class="route">
            Длина маршрута <span>
              {cityMeta.shop.name}
              {cityMeta.shop.address.street} – {route} = {long} км.</span
            > <br /> Доставка рассчитана из тарифа <span>1 км = 25 ₽</span>
          </p>
        {/if}
        <div class="button">
          <Button
        ...
        <div class="flex">
          <div class="delivery_stage relative flex">
            <div class="delivery_stage-icon">
              ...
              >
                <path
                  d="M46.5909 28.0418C42.0242 28.0418 44.3777 28.103 41.649 28.103C41.649 28.103 37.3555 29.0086 37.3555 22.9474C37.3555 19.0647 37.3555 20.6948 37.3555 16.4219H41.649C44.3752 16.4219 46.5909 18.5979 46.5909 21.2765V28.0418Z"
                  stroke="#E71F75"
                  stroke-width="2"
                  stroke-miterlimit="10"
                  stroke-linecap="round"
                ...
                />
                <path
                  d="M18.2374 47.0004C21.2346 47.0004 23.6643 44.6134 23.6643 41.6688C23.6643 38.7242 21.2346 36.3372 18.2374 36.3372C15.2402 36.3372 12.8105 38.7242 12.8105 41.6688C12.8105 44.6134 15.2402 47.0004 18.2374 47.0004Z"
                  stroke="#E71F75"
                  stroke-width="2"
                  stroke-miterlimit="10"
                  stroke-linecap="round"
                ...
                />
                <path
                  d="M35.6163 47.0004C38.6135 47.0004 41.0432 44.6134 41.0432 41.6688C41.0432 38.7242 38.6135 36.3372 35.6163 36.3372C32.6191 36.3372 30.1895 38.7242 30.1895 41.6688C30.1895 44.6134 32.6191 47.0004 35.6163 47.0004Z"
                  stroke="#E71F75"
                  stroke-width="2"
                  stroke-miterlimit="10"
                  stroke-linecap="round"
                ...
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M30.377 21.4191C30.377 18.2217 33.0155 15.6506 36.2359 15.6506H41.6474C44.8666 15.6506 47.5115 18.2205 47.5115 21.4191V37.0339C47.5115 40.2357 44.8685 42.7999 41.6474 42.7999H41.0396C40.7887 42.7999 40.5487 42.6978 40.3749 42.5171C40.201 42.3364 40.1083 42.0927 40.1181 41.8422C40.1204 41.7848 40.1215 41.727 40.1215 41.669C40.1215 39.2478 38.1203 37.259 35.6194 37.259C34.2259 37.259 32.9843 37.8777 32.159 38.8476C31.9365 39.1091 31.5871 39.2253 31.2523 39.1493C30.9174 39.0733 30.6525 38.8177 30.5649 38.4859C30.4421 38.0211 30.377 37.5343 30.377 37.0339V21.4191ZM36.2359 17.4938C34.0039 17.4938 32.2213 19.2696 32.2213 21.4191V36.3869C33.2044 35.7717 34.3706 35.4158 35.6194 35.4158C38.8643 35.4158 41.5607 37.8228 41.9242 40.9476C44.0292 40.8086 45.6672 39.0947 45.6672 37.0339V21.4191C45.6672 19.2708 43.8807 17.4938 41.6474 17.4938H36.2359Z"
                  fill="#E71F75"
                />
                <path
                  d="M9.65975 5.77362C9.65975 3.61928 11.4446 1.84316 13.6795 1.84316H32.5127C34.7485 1.84316 36.5375 3.62275 36.5375 5.77362V15.6506H38.3819V5.77362C38.3819 2.57245 35.7344 0 32.5127 0H13.6795C10.4568 0 7.81543 2.57082 7.81543 5.77362C7.81543 6.28259 8.2283 6.6952 8.73759 6.6952C9.24689 6.6952 9.65975 6.28259 9.65975 5.77362Z"
                  fill="#E71F75"
                />
                <path
                  d="M29.849 41.7409C29.849 41.4841 29.7697 41.1591 29.8001 40.9107H24.4136C24.444 41.1591 24.4597 41.4122 24.4597 41.669C24.4597 42.0392 24.4271 42.4017 24.3647 42.7538H29.849C29.7866 42.4017 29.849 42.1112 29.849 41.7409Z"
                  fill="#E71F75"
                />
                <path
                  d="M7.81543 36.9879C7.81543 39.5369 9.65944 41.7403 11.9743 42.5066C11.9417 42.2496 11.9743 41.9967 11.9743 41.7307C11.9743 41.3285 11.9929 40.9066 12.0663 40.526C10.7485 39.877 9.65975 38.5085 9.65975 36.9879V22.817C9.65975 22.308 9.24689 21.8954 8.73759 21.8954C8.2283 21.8954 7.81543 22.308 7.81543 22.817V36.9879Z"
                  fill="#E71F75"
                />
              </svg>
            </div>
            ...
            >
              <path
                d="M1 6H21M21 6L15.8718 1M21 6L15.8718 11"
                stroke="#330033"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
            ...
            <div class="delivery_stage-icon">
              ...
              >
                <g clip-path="url(#clip0)">
                  ...
                  />
                  <path
                    d="M21.54 30.3938C21.54 29.0391 22.6458 27.9333 24.0005 27.9333C25.3551 27.9333 26.4609 29.0391 26.4609 30.3938C26.4609 31.7484 25.3551 32.8542 24.0005 32.8542C22.6458 32.8542 21.54 31.7484 21.54 30.3938Z"
                    stroke="#E71F75"
                    stroke-width="2"
                  />
                  <path
                    d="M24.001 46.9834C26.9824 42.9719 31.9315 36.8226 32.1885 31.5169C32.4578 25.9553 28.899 22.8311 24.001 22.8311"
                    stroke="#E71F75"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M24.001 46.9834C21.0196 42.9719 16.0704 36.8226 15.8135 31.5169C15.5441 25.9553 19.103 22.8311 24.001 22.8311"
                    stroke="#E71F75"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M19.4427 20.389C15.9119 19.3094 12.5646 19.0837 11.1494 19.1582C11.1494 19.1582 11.2882 22.3692 12.9383 26.7667"
                    stroke="#E71F75"
                    stroke-width="2"
                    stroke-linecap="round"
                  />
                  <path
                    d="M28.5749 20.389C32.1056 19.3094 35.453 19.0837 36.8682 19.1582C36.8682 19.1582 36.7293 22.3692 35.0793 26.7667"
                    stroke="#E71F75"
                    stroke-width="2"
                    stroke-linecap="round"
                  />
                  <path
                    d="M31.1406 44.8671C40.3533 41.8892 46.9993 33.4194 46.9993 23.4358C46.9993 14.362 41.5094 6.53863 33.5922 2.95239"
                    stroke="#E71F75"
                    stroke-width="2"
                    stroke-linecap="round"
                  />
                  <path
                    d="M16.8877 44.8671C7.67497 41.8892 1.02904 33.4194 1.02904 23.4358C1.02904 14.362 6.51888 6.53863 14.4361 2.95239"
                    stroke="#E71F75"
                    stroke-width="2"
                    stroke-linecap="round"
                  />
          ...
          <div class="delivery_stage relative flex">
            <div class="delivery_stage-icon">
              ...
              >
                ...
                />
                <path
                  d="M12.3757 29H16.5C17.4293 29 17.894 29 18.2804 28.9231C19.8671 28.6075 21.1075 27.3671 21.4231 25.7804C21.5 25.394 21.5 24.9293 21.5 24C21.5 23.0707 21.5 22.606 21.4231 22.2196C21.1075 20.6329 19.8671 19.3925 18.2804 19.0769C17.894 19 17.4293 19 16.5 19H11.5C10.5707 19 10.106 19 9.71964 19.0769C8.13288 19.3925 6.89249 20.6329 6.57686 22.2196C6.5 22.606 6.5 23.0707 6.5 24C6.5 24.9293 6.5 25.394 6.57686 25.7804C6.84292 27.118 7.76613 28.2094 9 28.7083"
                  stroke="#E71F75"
                  stroke-width="1.5"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
                <path
                  d="M12.2578 29.2765C10.967 31.4233 7.96132 31.5655 7.96132 31.5655C8.90629 30.308 8.98946 28.8504 8.98946 28.8504"
                  stroke="#E71F75"
                  stroke-width="1.5"
                  stroke-miterlimit="10"
                  stroke-linecap="round"
      ...
      <div class="deliveri_FAQ" bind:this={FAQ}>
        ...
        <div class="deliveri_FAQ_qs">
          <HelpCategory
            className="questions-category_withoutMargin"
            qaList={deliveryQA}
...
{#if DeliveryCardModalVisible}
  <DeliveryCardModal
    city={city_name}
    shop_name={cityMeta.shop.name}
    shop_address={cityMeta.shop.address.street}
    bind:visible={DeliveryCardModalVisible}
    bind:route
  />
{/if}
