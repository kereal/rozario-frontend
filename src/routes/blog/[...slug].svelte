      ...
      <div class="header-buttons">
        <div>
          ...
          >
            <g clip-path="url(#clip0)">
              <path
                d="M9.5 8.00017C9.5 9.93509 11.0667 11.5001 13 11.5001C14.932 11.5001 16.5 9.93499 16.5 8.00017C16.5 6.06525 14.932 4.50012 13 4.50012C11.0667 4.50012 9.5 6.06515 9.5 8.00017Z"
                stroke="white"
              />
              <path
                d="M1.5 8.00009C5 3.00009 14.5 -3.99991 24.5 8.00009C21 13.1667 11.5 20.4 1.5 8.00009Z"
                stroke="white"
            ...
            <defs>
              <clipPath id="clip0">
                <rect
                  ...
                  height="16"
                  fill="white"
                  transform="matrix(1 0 0 -1 0 16.0001)"
                />
              </clipPath>
            </defs>
          </svg>
        ...
        {#if !headerShareOpened}
          <a class="open-share" href="#" on:click={openHeaderShare}>
            ...
            >
              <path
                d="M11.5 3.00015C11.5 4.10586 12.3952 5.00012 13.5 5.00012C14.6041 5.00012 15.5 4.10576 15.5 3.00015C15.5 1.89448 14.6041 1.00012 13.5 1.00012C12.3952 1.00012 11.5 1.89438 11.5 3.00015Z"
                fill="white"
                stroke="white"
              />
              <path
                d="M11.5 14.0002C11.5 15.1059 12.3952 16.0001 13.5 16.0001C14.6041 16.0001 15.5 15.1058 15.5 14.0002C15.5 12.8945 14.6041 12.0001 13.5 12.0001C12.3952 12.0001 11.5 12.8944 11.5 14.0002Z"
                fill="white"
                stroke="white"
              />
              <path
                d="M0.5 8.00015C0.5 9.10586 1.39519 10.0001 2.50003 10.0001C3.60407 10.0001 4.5 9.10576 4.5 8.00015C4.5 6.89448 3.60406 6.00012 2.50003 6.00012C1.3952 6.00012 0.5 6.89438 0.5 8.00015Z"
                fill="white"
                stroke="white"
              />
              <path
                d="M2.5 8.00012C2.88261 7.68012 11.4928 4.36679 15 2.50012"
                stroke="white"
              />
              <path
                d="M2.5 8.00012C2.88261 8.32012 11.4928 12.6335 15 14.5001"
                stroke="white"
              />
            </svg>
        ...
        <a class="subscribe" href="#" on:click={toggleBlogPopupPromocodeForm}>
          ...
          >
            <path
              d="M18.1875 0.00012207H1.8125C0.8125 0.00012207 0 0.781238 0 1.74261V12.2576C0 13.219 0.8125 14.0001 1.8125 14.0001H18.1875C19.1875 14.0001 20 13.219 20 12.2576V1.74261C20 0.781238 19.1875 0.00012207 18.1875 0.00012207ZM17.9375 1.08167L10 6.90999L2.0625 1.08167H17.9375ZM18.1875 12.8585H1.8125C1.4375 12.8585 1.125 12.5581 1.125 12.1975V1.74261L9.6875 7.99154C9.8125 8.05162 9.9375 8.11171 10 8.11171C10.0625 8.11171 10.25 8.05162 10.3125 7.99154L18.875 1.74261V12.1975C18.875 12.5581 18.5625 12.8585 18.1875 12.8585Z"
              fill="white"
            />
          </svg>
    ...
    <div class="blog-body">
      <div class="page-content">
        <div class="date-n-author">
          <time>{post.date_short}</time><span>, {post.author.name}</span>
        </div>
        <div class="html">
          {@html post.html1}
        </div>
        ...
        <div class="post-buttons">
          ...
          {#if !shareOpened}
            <a class="open-share" href="#" on:click={openShare}>
              ...
              >
                <path
                  d="M11.5 3.00003C11.5 4.10574 12.3952 5 13.5 5C14.6041 5 15.5 4.10564 15.5 3.00003C15.5 1.89436 14.6041 1 13.5 1C12.3952 1 11.5 1.89426 11.5 3.00003Z"
                  fill="#1039C9"
                  stroke="#1039C9"
                />
                <path
                  d="M11.5 14C11.5 15.1057 12.3952 16 13.5 16C14.6041 16 15.5 15.1056 15.5 14C15.5 12.8944 14.6041 12 13.5 12C12.3952 12 11.5 12.8943 11.5 14Z"
                  fill="#1039C9"
                  stroke="#1039C9"
                />
                <path
                  d="M0.5 8.00003C0.5 9.10574 1.39519 10 2.50003 10C3.60407 10 4.5 9.10564 4.5 8.00003C4.5 6.89436 3.60406 6 2.50003 6C1.3952 6 0.5 6.89426 0.5 8.00003Z"
                  fill="#1039C9"
                  stroke="#1039C9"
                />
                <path
                  class="no-fill"
                  d="M2.5 8C2.88261 7.68 11.4928 4.36667 15 2.5"
                  stroke="#1039C9"
                />
                <path
                  class="no-fill"
                  d="M2.5 8C2.88261 8.32 11.4928 12.6333 15 14.5"
                  stroke="#1039C9"
                />
              </svg>
              <span>Поделиться</span>
          ...
          <div class="yes-no" class:chose-no={choseNo} class:chose-yes={choseYes}>
            ...
            <button bind:this={questionYesButton} class="yes" on:click={toggleYes}>
              <svg
                width="17"
                height="18"
                viewBox="0 0 17 18"
...
{#if showBlogPopupPromocodeForm}
  <BlogPopupPromocodeForm
    on:close={toggleBlogPopupPromocodeForm}
    onSuccess={toggleBlogPopupSubscribeSuccess}
    onError={toggleBlogPopupEmailSubscribedError}
  />
{/if}
