...
<script>
	...
	const text="Здесь собраны все отзывы, оставленные покупателями и счастливыми получателями после доставки.";
	...
	onMount(() => {
		headers = [ LastPostsHeader, PresentsHeader, WeddingHeader, DateHeader, PartnersHeader, DecorHeader ];
	...
	<div class="blog-main w-full">
		...
		<div class="blog-body">
			...
			<div class="page-content"
				...
				<h2
						data-scrollspy
						bind:this={LastPostsHeader}>Последние записи</h2>
				<div class="posts">
				...
				<h2
						data-scrollspy
						bind:this={PresentsHeader}>Подарки</h2>
				<div class="posts">
				...
				<h2
						data-scrollspy
						bind:this={WeddingHeader}>Свадьба</h2>
				<div class="posts">
				...
				<h2
						data-scrollspy
						bind:this={DateHeader}>Свидание</h2>
				<div class="posts">
				...
				<h2
						data-scrollspy
						bind:this={PartnersHeader}>Партнёрам</h2>
				<div class="posts">
				...
				<h2
						data-scrollspy
						bind:this={DecorHeader}>Декор</h2>
				<div class="posts">
