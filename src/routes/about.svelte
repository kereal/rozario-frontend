...
<style>
  ...
  .header.header :global(.header::before) {
    background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.42) 47.27%, #000000 100%);
  }
  .page-content {
    flex-grow: 1;
    padding: 0 80px 34px;
...
<div id="about-us-page">
  ...
  <div class="blog-body">
    ...
    <div class="page-content"
      ...
      <h2
              data-scrollspy
              bind:this={AboutUsHeader}>О нас</h2>

      <div class="about-wrapper">
        <div class="about-info">
          <p>«Розарио» – это команда профессионалов с большим опытом работы во флористике. Мы предлагаем услуги по доставке цветов с 2011 года. Ежегодно наши флористы с любовью и заботой разрабатывают новые коллекции букетов, которые представлены к вашему вниманию. Все букеты тщательно подобраны по цветовой гамме.</p>
          ...
          <p>Наши профессиональные консультанты индивидуально подходят к каждому заказу, помогают подобрать самый лучший вариант букета и подарка. Ими написаны километры поздравлений, отправлено уже более 1 000 000 фотографий счастливых улыбок получателей. Заказать букет цветов – проще простого! Время оформления заказа до его оплаты не более 7 минут.</p>
          <p>Расстояние не должно стать преградой для любви и уважения, поэтому мы готовы доставить букет в течении двух часов в любую точку города и области! Доставка по городу бесплатно и открытка в подарок. Мы всегда найдем способ вручить букет цветов, где бы ни были ваши близкие. Доставим цветы в любое удобное место – на дом, в отель или офис.</p>
        </div>
      ...
      <h2
              data-scrollspy
              bind:this={SevenReasonsHeader}>7 причин купить у нас</h2>
      ...
      <h2
              data-scrollspy
              bind:this={MapHeader}>Карта покупателей</h2>
      <p>Более 1 000 000 счастливых покупателей по всей России. Станьте одним из них!</p>
      <div id="map" class="w-full h-full"></div>

      <h2
              data-scrollspy
              bind:this={BlogHeader}>Наш блог</h2>
      <p>Статьи о цветах и подарках, а также новости и акции в Розарио.Цветы</p>
      <Slider small="3" middle="4" forDesktop="4"
              smallSpaceBetween="0" middleSpaceBetween="0" bigSpaceBetween="6"
              middleSpaceBreakpoint="1200" bigSpaceBreakpoint="1300">
      ...
      <LinkButton href="/#mainCollection" className="map-button">Перейти в каталог</LinkButton>
    </div>
  </div>
</div>
