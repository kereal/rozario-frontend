...
<style>
    ...
    @media (max-width: 1300px) {
        ...
        .header, .contacts-body, .contacts-body :global(button .text-base) {
            font-size: 15px;
        }
    ...
    <div class="flex contacts-body">
        <div class="left flex-grow">
            ...
            <div
                    itemprop="address"
                    itemscope
                    itemtype="https://schema.org/PostalAddress">Адрес:
            ...
            <div class="contacts-text">Если у вас есть вопросы по вашему заказу, позвоните нам:</div>
            <div class="phones">
                <div class="local-phone">
                    <a itemprop="telephone" content="{phone_local}" class="text-main" href="tel:{phone_local}">{phone_local} </a>
                    <span class="text-gray-600">(бесплатно по России)</span>
                </div>
                <div class="global-phone">
                    <a itemprop="telephone" content="{phone_global}" class="text-main" href="tel:{phone_global}">{phone_global}</a>
