...
border: 1px solid var(--gray-300);"
    ...
    <div class="buttons items-center justify-between">
        <Button size="md" className="mr-12"><span class="whitespace-no-wrap" on:click={assignEmployees}>Назначить сотрудников</span></Button>
        <div class="cancel whitespace-no-wrap" on:click={closeModal}>Не сейчас</div>
    </div>
</ModalSurface>