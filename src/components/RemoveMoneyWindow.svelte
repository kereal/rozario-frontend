    ...
    <div class="item flex justify-between mt-24 first:mt-18">
      <div class="flex items-center">
        ...
        >
          ...
          <path
            d="M1.5 1.875C1.5 1.10827 2.10997 0.5 2.84615 0.5H7.54709C7.94895 0.5 8.334 0.661244 8.61594 0.947594L12.0688 4.45445C12.3451 4.73506 12.5 5.11306 12.5 5.50686V13.125C12.5 13.8917 11.89 14.5 11.1538 14.5H2.84615C2.10997 14.5 1.5 13.8917 1.5 13.125V1.875Z"
            stroke="#CC6699"
          />
          <path d="M12.5 5H8.6C7 5 7 3.8 7 3.4V1" stroke="#CC6699" />
          <circle cx="11" cy="12" r="3.5" fill="white" stroke="#CC6699" />
          <path
            d="M15.6437 17.3503C15.8371 17.5474 16.1537 17.5502 16.3507 17.3567C16.5477 17.1632 16.5506 16.8466 16.3571 16.6496L15.6437 17.3503ZM13.404 15.0701L15.6437 17.3503L16.3571 16.6496L14.1175 14.3694L13.404 15.0701Z"
            fill="#CC6699"
          />
        </svg>
      </div>
