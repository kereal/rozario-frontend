      ...
      guards: {
        ...
        ifEnd: () => {
          if (currentState === "occasion") {
            return filter.flower.text && filter.person.text
          } else if (currentState === "person") {
            return filter.occasion.text && filter.flower.text
          } else {
            return filter.occasion.text && filter.person.text && filter.flower.text
          }
        }
      }
    }
