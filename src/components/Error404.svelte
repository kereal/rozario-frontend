<script>
    ...
    class Puzzle {
        ...
        checkIfWon() {
            let res = '';
            document.querySelectorAll('.puzzle-image').forEach(item => res += item.getAttribute('data-i'));
            if (res === this.key) {
                this.showSuccess();
                this.stopTimer();
            }
...
<style>
    ...
    .error-404-wrapper {
        margin: 2px 0 11px;
        background: linear-gradient(180deg, var(--color-light) 0%, rgba(255, 255, 255, 0) 100%), var(--gray-100);
    ...
    .puzzle-present {
        ...
        z-index: -1;
        opacity: 0;
        transition: .7s ease-in .7s;
    }
    .puzzle-present img {
        position: absolute;
    }
    .puzzle-present-inner {
        background: linear-gradient(180deg, rgba(255, 255, 255, 0.83) 0%, rgba(255, 255, 255, 0) 57.98%);
    }
...
<div class="error-404-wrapper">
    <div class="fox-column">
        <img
                ...
                404/404-fox.png 2x,
                404/404-fox.png 3x" class="fox-image" alt="">
    ...
    <div class="puzzle-column">
        ...
        <div class="puzzle-message">
            ...
            <p>Перемещай кусочки пазла, собери картинку и получи приз!</p></div>
                ...
                <div class="puzzle-row">
                    <div class="puzzle-cell">
                        <div class="puzzle-image-wrapper" draggable="true">
                            <div class="puzzle-image" data-i="{order[0]}"><img data-src="404/puzzle{order[0] + 1}.png"
                                                                               data-srcset="404/puzzle{order[0] + 1}.png,
                                                                                            404/puzzle{order[0] + 1}.png 1.5x,
                                                                                            404/puzzle{order[0] + 1}.png 2x,
                                                                                            404/puzzle{order[0] + 1}.png 3x" alt="" /></div>
                        </div>
                    </div>
                    <div class="puzzle-cell">
                        <div class="puzzle-image-wrapper" draggable="true">
                            <div class="puzzle-image" data-i="{order[1]}"><img data-src="404/puzzle{order[1] + 1}.png"
                                                                               data-srcset="404/puzzle{order[1] + 1}.png,
                                                                                            404/puzzle{order[1] + 1}.png 1.5x,
                                                                                            404/puzzle{order[1] + 1}.png 2x,
                                                                                            404/puzzle{order[1] + 1}.png 3x" alt="" /></div>
                        </div>
                    </div>
                    <div class="puzzle-cell">
                        <div class="puzzle-image-wrapper" draggable="true">
                            <div class="puzzle-image" data-i="{order[2]}"><img data-src="404/puzzle{order[2] + 1}.png"
                                                                               data-srcset="404/puzzle{order[2] + 1}.png,
                                                                                            404/puzzle{order[2] + 1}.png 1.5x,
                                                                                            404/puzzle{order[2] + 1}.png 2x,
                                                                                            404/puzzle{order[2] + 1}.png 3x" alt="" /></div>
                        </div>
                    </div>
                </div>
                <div class="puzzle-row">
                    <div class="puzzle-cell">
                        <div class="puzzle-image-wrapper" draggable="true">
                            <div class="puzzle-image" data-i="{order[3]}"><img data-src="404/puzzle{order[3] + 1}.png"
                                                                               data-srcset="404/puzzle{order[3] + 1}.png,
                                                                                            404/puzzle{order[3] + 1}.png 1.5x,
                                                                                            404/puzzle{order[3] + 1}.png 2x,
                                                                                            404/puzzle{order[3] + 1}.png 3x" alt="" /></div>
                        </div>
                    </div>
                    <div class="puzzle-cell">
                        <div class="puzzle-image-wrapper" draggable="true">
                            <div class="puzzle-image" data-i="{order[4]}"><img data-src="404/puzzle{order[4] + 1}.png"
                                                                               data-srcset="404/puzzle{order[4] + 1}.png,
                                                                                            404/puzzle{order[4] + 1}.png 1.5x,
                                                                                            404/puzzle{order[4] + 1}.png 2x,
                                                                                            404/puzzle{order[4] + 1}.png 3x" alt="" /></div>
                        </div>
                    </div>
                    <div class="puzzle-cell">
                        <div class="puzzle-image-wrapper" draggable="true">
                            <div class="puzzle-image" data-i="{order[5]}"><img data-src="404/puzzle{order[5] + 1}.png"
                                                                               data-srcset="404/puzzle{order[5] + 1}.png,
                                                                                            404/puzzle{order[5] + 1}.png 1.5x,
                                                                                            404/puzzle{order[5] + 1}.png 2x,
                                                                                            404/puzzle{order[5] + 1}.png 3x" alt="" /></div>
                        </div>
                    </div>
                </div>
                <div class="puzzle-row">
                    <div class="puzzle-cell">
                        <div class="puzzle-image-wrapper" draggable="true">
                            <div class="puzzle-image" data-i="{order[6]}"><img data-src="404/puzzle{order[6] + 1}.png"
                                                                               data-srcset="404/puzzle{order[6] + 1}.png,
                                                                                            404/puzzle{order[6] + 1}.png 1.5x,
                                                                                            404/puzzle{order[6] + 1}.png 2x,
                                                                                            404/puzzle{order[6] + 1}.png 3x" alt="" /></div>
                        </div>
                    </div>
                    <div class="puzzle-cell">
                        <div class="puzzle-image-wrapper" draggable="true">
                            <div class="puzzle-image" data-i="{order[7]}"><img data-src="404/puzzle{order[7] + 1}.png"
                                                                               data-srcset="404/puzzle{order[7] + 1}.png,
                                                                                            404/puzzle{order[7] + 1}.png 1.5x,
                                                                                            404/puzzle{order[7] + 1}.png 2x,
                                                                                            404/puzzle{order[7] + 1}.png 3x" alt="" /></div>
                        </div>
                    </div>
                    <div class="puzzle-cell">
                        <div class="puzzle-image-wrapper" draggable="true">
                            <div class="puzzle-image" data-i="{order[8]}"><img data-src="404/puzzle{order[8] + 1}.png"
                                                                               data-srcset="404/puzzle{order[8] + 1}.png,
                                                                                            404/puzzle{order[8] + 1}.png 1.5x,
                                                                                            404/puzzle{order[8] + 1}.png 2x,
                                                                                            404/puzzle{order[8] + 1}.png 3x" alt="" /></div>
                        </div>
                    </div>
                </div>
            </div>
...
{#if puzzleModalVisible}
    <PuzzleModal
            on:close={togglePuzzleModalVisible} />
{/if}

{#if puzzlePhoneModalVisible}
    {#if !puzzlePhoneFinalModalVisible}
        <PuzzleModalPhone onRes="{openPuzzlePhoneFinalModal}" on:close={closePuzzlePhoneModal} />
    {/if}
    {#if puzzlePhoneFinalModalVisible}
