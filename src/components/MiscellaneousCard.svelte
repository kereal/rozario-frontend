  ...
  const postCardList = [
    {
      text: "День рождения",
      name: "birthday",
      postcardtext: "С днём рождения, счастья, здоровья!"
    },
...
<div class="bg-cardbg rounded form-misc-card">
  <h2 class="text-main font-semibold pb-24 text-xl leading-tight">Дополнительно</h2>
    ...
    {#if addPostCard}
      <div class="margin mb-30 ">
        ...
        <div class="mt-16 holidaysButton">
          ...
          />
          <div
            class="product__postCartBlock relative mb-24"
