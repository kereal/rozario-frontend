...
>
  ...
  >
    <div class="content-left">
      <div class="mb-18 hidden lg:flex justify-between text-one-five leading-mid">
    ...
    <div class="content-right">
      <div class="flex flex-col justify-between">
        ...
        <div class="mb-18">
          <div class="text-main text-one-five font-bold leading-mid mb-16">Ваш отзыв</div>
        ...
        <div class="mb-24">
          <div class="text-main font-bold text-sm leading-tight mb-6">Хорошо</div>
      ...
      <div class="w-full">
        <Button className="ml-auto" textClass="text-base" status="active-main" size="lg">
          Повторить заказ
        </Button>
      </div>
    </div>
