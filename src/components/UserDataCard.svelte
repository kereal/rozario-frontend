...
<div
  id="form-user-data"
  class="bg-cardbg {tab === 'me' ? 'pt-34' : ''} rounded form-user-data"
>
  <h2 class="text-main font-semibold mb-24 text-xl leading-tight">Ваши данные</h2>
  <div class="w-full">
    <div class="gap">
    ...
    <div class="mt-30 flex">
      <span>
        <img
          class="inline-block warranty-image"
          width="17"
          height="24"
          src="warranty.svg"
          alt="icon"
