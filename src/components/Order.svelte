...
<div class="h-full flex flex-col">
  <div class="content h-0 bg-gray-100 rounded w-full flex flex-col">
    <div class="custom-scrollbar flex-1 overflow-auto">
        ...
        <div class="flex items-center justify-between">
          ...
          {#if orderList.length}
            <div class="delete-button" on:click={removeOrder}>
              <svg class="" width='20px' height='20px' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
          ...
          <div class="mb-16 pt-14 border-t border-gray-1000">
            {#if postcard != 0}
              <div class="text-main flex justify-between mb-12">
                ...
                <div style="{$page.path == '/cart'? 'margin-left: 120px;': 'margin-left: 77px;'}" class="countPostCard">{postcard}</div>
      ...
      {#if $page.path == '/cart'}
      <div class="rounded-b border-t border-b border-gray-300 p-24 pl-18 footer flex
      items-center justify-between">
      <div class="text-gray-600 text-one-five leading-mid text-right">
        Итого
      </div>
      ...
      {:else}
      <div  class="rounded-b border-t border-b border-gray-300 p-24 pt-18 pl-18 footer flex justify-between">
        <div>
          <div class="text-gray-700  order__footer-name">
          ...
          <div class="pen-icon">
            <svg fill="var(--color-main)" width="15" height="15" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path d="M29.6 2.3c-2.7-2.7-7.1-2.7-9.8 0L1.7 20.1c-.2.2-.2.2-.4.6L0 30.7c0 .2.2.6.4.8.4 0 .6.2.8.2h.2l6.1-.8c.6-.2 1-.6.8-1-.2-.4-.6-.8-1-.8l-4.9.6 1-6.9 7.3 7.3c.2.2.4.2.6.2.2 0 .6-.2.6-.2L30 12.2c1.4-1.4 2.2-3.1 2.2-4.9s-1.2-3.6-2.6-5zm-9.4 2.3l3.1 2.9L6.8 24.1 3.7 21 20.2 4.6zm-9.1 23.6l-2.9-2.9L24.7 8.8l2.9 2.9-16.5 16.5zm17.7-17.7l-7.3-7.3c1-.8 2.2-1.2 3.3-1.2 1.4 0 2.7.6 3.7 1.6.8 1 1.2 2.2 1.2 3.5.3 1.5-.3 2.6-.9 3.4z"></path></svg>
          </div>
          </div>
        </div>
  ...
  {#if $page.path !== '/cart'}
    <a
      href="cart"
      class="checkout-button font-semibold mt-6 flex-shrink-0 text-center rounded w-full px-16 py-8 {orderList.length ? 'active' : 'disabled'}">
      Оформить заказ
    </a>
  {/if}
