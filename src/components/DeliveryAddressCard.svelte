...
<div class="relative rounded h-full bg-white px-24 pt-34 pb-48 shadow-card">
  {#if isMainAddress}
    <span class="absolute-text text-xs text-info leading-tight"> Основной адрес </span>
  {/if}
    ...
    <ul class="text-one-five mb-24">
      <li class="flex mb-12 leading-mid">
        <div class="mr-12 pt-4">
          <Icon name={Avatar} iconSize="15" classNames="fill-current text-infolight" />
        </div>
        <span class="text-main">{recipient.name}</span>
      </li>
      <li class="flex mb-12 leading-mid">
        <div class="mr-12 pt-4">
          <Icon name={House} iconSize="15" classNames="fill-current text-infolight" />
        </div>
      ...
      <li class="flex mb-12 leading-mid">
        <div class="mr-12 pt-4">
          <Icon name={Phone} iconSize="15" classNames="fill-current text-infolight" />
        </div>
