...
<Portal>
  <div transition:fade on:click={closeViaOverlay} class="overlay">
    <div bind:this={modalElement} class="modal relative">
      ...
      <div class="postcard">
        <h2 class="deliverycard__name flex items-center">
        ...
        <h3 class="deliverycard__descript">
          Ближайшая дата доставки в {city}:
          <span class="text-main">22 августа 2020, в течение 120 мин</span>
        </h3>
        <h3 class="deliverycard__descript">
          Местное время: <span class="text-main">18:00, 04.08.2020</span>
        </h3>
        ...
        <fieldset class="info w-full flex flex-col">
          ...
          <div class="flex justify-between">
            ...
            <div class={selectedPeriod == "noTime" ? "SelectPrice" : "noneSelectPrice"}>
              0 ₽
            </div>
          </div>
        </fieldset>
