<script>
    ...
    const gift = {
        ...
        description: 'Корзина, декоративная лента, ананас (1 шт.), яблоко (4 шт.), банан (10 шт.), виноград чёрный (1 шт.), виноград белый (1 шт.), мандарин (3 шт.), апельсин (4 шт.)',
    ...
    <div transition:fade on:click={closeViaOverlay} class="overlay">
        <div
            ...
            <div class="gift__footer">
                ...
                <div>
                    <button class="gift__add" on:click={closeViaOverlay}> Добавить в корзину</button>
                </div>
            </div>
        </div>
    </div>
