...
<script>
    ...
    export let garantText = String("100% гарантия свежести." +
    ...
    let product = {
        ...
        check: 'Розовый цвет очень любим многими женщинами и девушками. С этим букетом вы прекрасно сможете продемонстрировать всю красоту данного оттенка.' +
                'Помимо замечательных роз с розовым оттенком, данный букет хорошо дополняют синий лимониум, белые хризантемы и листья эвкалипта с фетром.',
        name: 'Во имя любви',
        sizes: [
            {
            ...
            <div class="product__fixedButton_right flex">
                {#if product.descriptions}
                    <div class="product__price flex">
                        <span class="product__price_main flex"><AnimateNumber number=3800 />&nbsp;₽</span>
