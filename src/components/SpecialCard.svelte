...
<div class="wrapper flex flex-col rounded-lg">
  <div class="image-placeholder rounded-t-lg bg-white relative">
    ...
    <noscript>
      <img
        srcset="{recommendation.img}-2x.png"
