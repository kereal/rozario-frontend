  ...
  function listKeyDown(e) {
    ...
    switch (e.key) {
      ...
      case "Tab":
        ...
        break;
      case "ArrowDown":
        currentFocused = document.querySelector(
          '.custom-select li[tabindex="0"]'
        );
...
<div
  ...
  <div
    ...
    selected h-full flex cursor-pointer items-center justify-between {hidden ? 'border rounded text-main' : 'text-gray-700 border-t border-r border-l rounded-t'}
    leading-tight">
