    ...
    <div class="text-one-five">
      <div>
        ...
        <div class="margin mt-24">
          <label class="inline-block text-ssm leading-tight text-gray-600 mb-16">
            Время доставки
          </label>
          <fieldset class="info w-full flex flex-col">
            {#each deliveryPeriods as period}
              <div class="flex justify-between">
                ...
                <div
                  class={selectedPeriod === period.name
                    ? "SelectPrice"
                    : "noneSelectPrice"}
                >
                  {period.price} ₽
            ...
            <div class="flex justify-between">
              ...
              <div
                class={selectedPeriod == "no_time" ? "SelectPrice" : "noneSelectPrice"}
              >
                от 0 ₽
              </div>
            </div>
