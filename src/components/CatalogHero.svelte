...
<div class="wrapper relative text-white w-full ">
  ...
  <div class="hero-gradient w-full relative">
    <div
      class="mt-auto hero-content z-10 pb-16 w-full h-auto absolute bottom-0">
      <div class="px-44 lg:px-34 xl:px-80">
        ...
        <h1 class="tittle pt-8 pb-18 font-bold leading-tight">
          {title.name}
        </h1>
      </div>
      <div
        class="w-full buttons-wrapper mx-auto flex items-stretch
         mb-14 px-44 lg:px-34 xl:px-80 ">
          ...
          <div >
            <InfoButton
              ...
              <section class="leading-tight rounded bg-white px-32 py-24">
                <h3 class="text-main text-lg font-bold mb-8">
          ...
          <InfoButton
            ...
            <section class="rounded bg-white px-32 py-24">
              ...
              <p class="text-sm text-gray-700">
                Позвоним получателю и уточним адрес получения, без раскрытия
                информации о содержании доставки
              </p>
            </section>
          </InfoButton>
          <div>
