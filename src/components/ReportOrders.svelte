                    ...
                    {#each order.products as product}
                        <div class="product flex justify-between mb-8">
                            ...
                            <div class="details__right flex justify-between details__Maintext">
                                ...
                                <div class="whitespace-nowrap">{product.price * product.amount}  ₽</div>
                            </div>
                        </div>
                    {/each}
...
{#if counter > 0}
    <TableStrip>
        <div class="flex items-center">
            ...
            <div>
                <Button size="lg"><span class="whitespace-nowrap">{counter < 2 ? 'Скачать документ' : 'Скачать документы'}</span></Button>
            </div>
            <div class="ml-30">
