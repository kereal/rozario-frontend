...
<div id="payment-cash-legal" class="mt-20 payment-cash-legal">
  ...
  <div class="mb-18 text-gray-600 leading-snug text-ssm whitespace-no-wrap">Работает автоподстановка - начните вводить название юр. лица или ИП</div>
  <div class="w-full">
    <div class="mb-24">
      <div class="validation">
        <label class="label-text" for="form-company-name">
          Название юр. лица
        </label>
    ...
    <div class="mb-24">
      <div class="validation">
        <label class="label-text" for="form-legal-address">
          Юридический адрес
        </label>
        <span class="error-text invisible legalAddress">
    ...
    <div class="mb-24">
      <div class="validation">
        ...
        <span class="error-text invisible bankName">
