...
<div class="wrapper" class:searching class:opened bind:this={menuElement}>
  ...
  <div class="bottom-button">
    <a href="/help" bind:this={link}>
      <Button>Перейти на страницу помощи</Button>
    </a>
  </div>
</div>
...
<style>
  ...
  .search :global(i.search),
  .search :global(i.close) {
    top: 15px;
  }
  .search :global(svg) {
    width: 14px;
