    ...
    <div transition:fade on:click={closeViaOverlay} class="overlay">
        <div
            ...
            <div class="postcard">
                ...
                <h3 class="postcard__descript">Вы можете использовать готовое поздравление или написать своё</h3>
                <p contenteditable="true" bind:innerHTML={value} bind:this={element}  class='{maximum ? "errorBorder" : ""} textarea'></p>
                <div class="{maximum ? 'errorText': 'errorFalse'} flex"><img src="errorText.svg" class="errImg" alt="errorText">Слишком длинный текст</div>
