...
<div on:click={toggleCalendar} bind:this={wrapper} tabindex="0" class="cursor-pointer rounded border border-gray-500 bg-white flex {className}">
  <button
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20" fill="none">
      <path d="M17 17.2487C17 18.2137 16.0654 19 14.908 19H3.09187C1.93918 19 1 18.2177 1 17.2487V4.19122C1 3.22621 1.93444 2.43994 3.09187 2.43994H14.908C16.0654 2.43994 17 3.22621 17 4.19122V17.2487Z" stroke="#330033" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M13 1L13 3.88" stroke="#330033" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M5 1L5 3.88" stroke="#330033" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M1 7.04004H17" stroke="#330033" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </button>
  <input
    bind:this={ref}
